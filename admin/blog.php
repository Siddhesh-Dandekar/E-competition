                        ...
                        <div class="container px-6 py-8 mx-auto">
                            ...
                            <div class="flex items-start flex-col mt-4">
                                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                    <div
                                        class="bg-gray-400 inline-block flex justify-center min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                                        <div class="p-5">
                                            <form action="php_store_blog.php" method="post"
                                                enctype="multipart/form-data">

                                                <div class="mb-2.5">
                                                    <label for="base-input"
                                                        class="block mb-2 text-base font-medium text-gray-900 dark:text-black">Heading</label>
                                                ...
                                                <div class="mb-6">
                                                    <label for="default-input"
                                                        class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Author
                                                        Name
                                                    </label>
                                                ...
                                                <div class="min-w-72 mb-4 ">


                                                    <label for="message"
                                                        class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Your
                                                        message</label>
                                                    <textarea id="blog_content" name="blog_content" required rows="4"
