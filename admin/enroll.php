                ...
                <div class="flex flex-col flex-1 overflow-hidden">
                    ...
                    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                        <div class="container px-6 py-8 mx-auto">
                            <h3 class="text-3xl font-medium text-gray-700">Enrolled Students</h3>
                                    ...
                                    <div
                                        ...
                                        <table class="min-w-full">
                                            ...
                                            <tbody class="bg-white">
                                                <?php
                                                $sql = "SELECT e.enrolled_id, e.user_id, e.competition_id, u.user_name, u.branch, u.phone, c.title, c.game_id, g.game_name
                                                FROM enrolled e
                                                ...
                                                if ($stmt->execute()) {
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        // Fetch all enrollments with user, competition, and game information
                                                    ...
                                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                        <div class="flex items-center">
                                                            ...
                                                            <div class="ml-4">
                                                                ...
                                                                <div class="text-sm leading-5 text-gray-500">' . $row['branch'] . '</div>
                                                            </div>
                                                        </div>
                                                    </td>
